...
from lagartomqtt.config import MqttConfig
...
class XmlLagarto(object):
    ...
    def _read(self):
        ...
        if comms is not None:
            ...
            disable_set_value = comms.find("http_disable_set_value")
            if disable_set_value is not None:
                self.http_disable_set_value = bool(disable_set_value.text)
    ...
    def save(self):
        ...
        try:
            ...
            if self.http_disable_set_value is not None:
                f.write("\t\t<http_disable_set_value>" + str(self.http_disable_set_value) + "</http_disable_set_value>\n")
    ...
    def __init__(self, file_name="lagarto.xml"):
        ...
        ## HTTP disable set_value
        self.http_disable_set_value = False
